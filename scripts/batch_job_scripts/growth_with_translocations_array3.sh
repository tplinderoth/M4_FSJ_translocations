...
#! Name of the job:
#SBATCH -J growth_wtrans3
#! Account name for group, use SL2 for paying queue:
#SBATCH -A general
#! Output filename:
#! %A means slurm job ID and %a means array index
#SBATCH --output=growth_wtrans3_%A_%a.out
#! Errors filename:
#SBATCH --error=growth_wtrans3_%A_%a.err
...
MODEL='grow_wtrans'
INDIVIDUALS_FILE='/mnt/research/Fitz_Lab/projects/mosaic/simulations/pop_sims/inputs/cr_individuals_20241014.tsv'
...
EVENTS_FILE='/mnt/research/Fitz_Lab/projects/mosaic/simulations/pop_sims/inputs/pair_limits_grow.tsv'
