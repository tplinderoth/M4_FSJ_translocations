...
#! Name of the job:
#SBATCH -J sim_pedigree_contributions
#! Account name for group, use SL2 for paying queue:
#! #SBATCH -A ACCOUNT_NAME
#! Output filename:
#! %A means slurm job ID and %a means array index
#SBATCH --output=sim_ped_analysis_%A_%a.out
#! Errors filename:
#SBATCH --error=sim_ped_analysis_%A_%a.err
...
NEST_META_F='/mnt/research/Fitz_Lab/projects/mosaic/simulations/pedigree_sims/inputs/nest_metadata_20241115.tsv'
...
SIM_WRAPPER='/mnt/research/Fitz_Lab/projects/mosaic/simulations/pedigree_sims/scripts/pedSimStats.pl'
